...
setUpHotkeys = ->
  ...
  hotkeyCycleLayouts = awful.key mod, 'Tab',  cycleLayouts

  globalkeys = awful.util.table.join hotkeyRunCommand, hotkeyStartPomodoro,
    hotkeyStopPomodoro, hotkeyRandomWallpaper, hotkeyCycleLayouts
